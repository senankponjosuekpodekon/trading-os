...
ArindamOSS
ArindamOSS
Merge pull request #6659 from softdevfz/add-mostexpensivewatches
c4cfee6
 · 
5 days ago
.github
...
Filestack	Powerful API to upload, transform & deliver any file into your app	Run In Postman
...
BlazePhoenix	On-chain DEX aggregator quotes and route execution data	No	Yes	Yes
Block Lottos	On-chain lottery, draw history, jackpot and advertising endpoints	No	Yes	Yes
...
btcnode.uk	Bitcoin blockchain data, fees, mempool, SEC insider trades, Reddit sentiment. x402 micropayments for paid endpoints.	No	Yes	Unknown
...
Hyperliquid Market Data	Hyperliquid open interest, funding and cross-venue predicted rates per coin	apiKey	Yes	Yes
...
Mexc	Cryptocurrency info, place order	apiKey	Yes	Unknown
...
PumpFunData	Historical Pump.fun and PumpSwap AMM swap data as hourly Parquet files	apiKey	Yes	Unknown
...
Zennet	x402 pay-per-use APIs: Polymarket signals, CEX/DEX spreads, contract risk scores, gas oracle	No	Yes	Yes
...
Fixer	Exchange rates and currency conversion	apiKey	No	Unknown
...
Exchangerate.dev	Live & historical FX, 168 pairs back to 1999, Frankfurter-compatible, free 10k/mo	No	Yes	Unknown
...
paralelo.bo	Bolivia parallel-market USD/BOB exchange rate, aggregated from P2P sources every 60s	No	Yes	Yes
TaxID	EU VAT number validation with company name and address lookup across all 27 member states	apiKey	Yes	Unknown
...
Development
API	Description	Auth	HTTPS	CORS
Userstack	Secure User-Agent String Lookup JSON API	OAuth	Yes	Unknown
...
Amazonscraperapi	Amazon product, search & batch scraping API with residential proxies (1000 free)	apiKey	Yes	No
...
BrewPage	Free hosting for HTML, JSON, key-value, files, multi-file sites with short URLs and TTL retention	No	Yes	No
...
DownStatus	Real-time status for GitHub, AWS, Discord and 90+ services	No	Yes	Yes
...
Hipsum	Hipster-themed lorem ipsum generator for placeholder text	No	Yes	Unknown
...
isitdownstatus	Check if websites and online services are currently down	No	Yes	Unknown
...
JSONPlaceholder	Fake REST API for testing and prototyping	No	Yes	Yes
Keyvalue	Simple key-value storage REST API for quick prototyping	No	Yes	Unknown
...
MyIPRightNow	Public IP address with network, location, and connection details	No	Yes	Yes
...
OpenQR	Generate QR codes and manage dynamic (editable) QR codes with scan analytics	apiKey	Yes	Yes
...
QR & Barcode	QR codes and barcodes (Code 128, EAN-13, Data Matrix, PDF417 + more). SVG or PNG output	No	Yes	Yes
...
QR Code Crafter	Generate static QR codes in SVG, PNG, JPG, WebP, PDF, or EPS	No	Yes	Yes
...
Screenshot	Take programmatic screenshots of web pages from any website	apiKey	Yes	Yes
...
SiteIntel	Extract metadata, tech stack, emails, and screenshots from any URL	apiKey	Yes	Unknown
...
Suprsonic	Unified agent API: search, scrape, enrich, image gen, TTS, STT, messaging. One key, 20+ capabilities	apiKey	Yes	Yes
Talordata	SERP data from major search engines with a free trial	apiKey	Yes	Unknown
Thunder Client	API testing tool	No	Yes	Yes
Thunderbit	Extract web pages as Markdown or structured data for AI apps	apiKey	Yes	Unknown
...
Webclaw	Web content extraction for LLMs with scrape, crawl, search, and summarize	apiKey	Yes	Yes
...
BuildPDF	Convert HTML, images, and text to PDF	apiKey	Yes	Yes
...
PDFFleet	HTML and URL to PDF API with templates and a free tier	apiKey	Yes	Yes
Pocket	Bookmarking service	OAuth	Yes	Unknown
Podio	File sharing and productivity	OAuth	Yes	Unknown
PolyDoc	HTML/URL to PDF and screenshots, plus Factur-X/ZUGFeRD e-invoices; free tier	apiKey	Yes	Unknown
PrexView	Data from XML or JSON to PDF, HTML or Image	apiKey	Yes	Unknown
Renderly	HTML to PDF conversion API built on Chromium	apiKey	Yes	Yes
Rendex	Render HTML, Markdown, or URLs to PNG/JPEG/WebP/PDF, with extraction and templating	apiKey	Yes	Unknown
...
Smart Image Enhancement	Performs image upscaling by adding detail to images through multiple super-resolution algorithms	apiKey	Yes	Unknown
staffSign	Digital employment contract API with QES/eIDAS support for HR and staffing	apiKey	Yes	Yes
...
Zero Retention PDF	Zero-retention HTML to PDF conversion	apiKey	Yes	Unknown
⬆ Back to Index


Email
API	Description	Auth	HTTPS	CORS
mailboxlayer	Email address validation	apiKey	Yes	Unknown
...
EmailJS	Send emails directly from client-side JavaScript without a backend server	apiKey	Yes	Yes
...
Kiprio Email Validate	Free email validation: MX check, disposable detection, syntax	apiKey	Yes	Yes
...
PostStack	EU-hosted email API for transactional and marketing email, with contacts, broadcasts, and analytics	apiKey	Yes	No
...
Entertainment
API	Description	Auth	HTTPS	CORS
Anycrap	35,000+ absurdist AI-generated product concepts with names, descriptions, and images	apiKey	Yes	Yes
...
JokeAPI	Programmable jokes in multiple languages with filtering options	No	Yes	Yes
justmeme.wtf	Free meme API with 2400+ templates, search, trending, and AI generation	No	Yes	Yes
Meme Maker	REST API for create your own meme	No	Yes	Unknown
Memesio	Meme creation API with templates, editable captions and hosted share links	No	Yes	No
NaMoMemes	Memes on Narendra Modi	No	Yes	Unknown
PotterDB	Harry Potter universe database with characters, spells, potions and more	No	Yes	Yes
Random Useless Facts	Get useless, but true facts	No	Yes	Unknown
TasteDive	Content-based recommendations for movies, music, TV shows, books, games, and podcasts	apiKey	Yes	No
...
Solematica	Compare Italian solar (photovoltaic) installer offers, energy prices (PUN/ARERA) and satellite roof data	No	Yes	No
Srp Energy	Hourly usage energy report for Srp customers	apiKey	Yes	No
SustainMetrics	18,000+ GHG emission factors from DEFRA, EPA, ADEME, Ember	apiKey	Yes	Yes
...
Finance
API	Description	Auth	HTTPS	CORS
Marketstack	Real-Time, Intraday & Historical Market Data API	apiKey	Yes	Unknown
...
Bank Data	Instant IBAN and SWIFT number validation across the globe	apiKey	Yes	Unknown
...
BriefTape	Real-time AI-summarized SEC filings, Fed, FDA and BLS data, ticker-tagged	apiKey	Yes	Yes
Citi	All Citigroup account and statement data APIs	apiKey	Yes	Unknown
CongressInvests	Real-time U.S. congressional stock trade disclosures from Senate EFD and House Clerk	apiKey	Yes	Yes
Dino.markets	Matched Kalshi and Polymarket prediction-market data, cross-venue spreads	apiKey	Yes	No
Econdb	Global macroeconomic data	No	Yes	Yes
EconPulse	Live economic data — CPI, PPI, energy, treasury rates, BTC premium	apiKey	Yes	Yes
Edgrapi	Clean SEC EDGAR company financials, ratios, filings and 10-K/10-Q sections as normalized JSON	apiKey	Yes	Unknown
...
Goldprice.dev	Cross-validated gold, silver & copper spot, futures & 30-year history in 13 currencies	No	Yes	Unknown
Helium	News with media bias scoring, balanced news synthesis, live market data, AI options pricing	No	Yes	Yes
Hotstoks	Stock market data powered by SQL	apiKey	Yes	Yes
IBANforge	IBAN validation and BIC/SWIFT lookup for 75+ countries with 121K+ bank entries	No	Yes	Yes
...
StockFit	SEC filings, financial statements, earnings, ETF holdings and ownership data	apiKey	Yes	Yes
Styvio	Realtime and historical stock data and current stock sentiment	apiKey	Yes	Unknown
Sugra	One API for market data, economics, commodities, climate, and global news. LLM-ready JSON	apiKey	Yes	Yes
Tax Data	Instant VAT number and tax validation across the globe	apiKey	Yes	Unknown
Top 5 Stocks	Daily AI-ranked stock and crypto watchlists	No	Yes	Unknown
...
VAT Validation	Validate VAT numbers and calculate VAT rates	apiKey	Yes	Yes
...
RecipeAPI	Recipes, ingredients, nutrition data and cooking instructions	apiKey	Yes	Yes
...
Astroworld	Free Minecraft data: mobs, biomes, items, enchantments, structures, commands, versions, achievements, trades	No	Yes	Yes
...
Call of Duty Mobile	Unofficial API for CODM player data and daily cache claiming	No	Yes	Unknown
...
ApogeoAPI	Bundled API for countries, states, cities, IP geolocation, and live exchange rates	apiKey	Yes	Yes
...
BdAPIs	Get divisions, districts, and upazzilas of Bangladesh	No	Yes	Unknown
...
HackMyIP	IP geolocation, ISP and privacy/VPN scoring, email breach checks, DNS and WHOIS lookups	No	Yes	Yes
...
IP-API.io	IP geolocation with VPN/proxy/Tor detection, reputation and risk score	apiKey	Yes	Yes
IP Geolocation	Geolocate website visitors from their IPs	apiKey	Yes	Yes
...
ip2geo.dev	Programmatically convert IP addresses into geolocation data	apiKey	Yes	Yes
...
Kiprio UK Postcode	UK postcode lookup with lat/lon, district, ward, constituency	apiKey	Yes	Yes
LatLng	Geocoding, reverse geocoding, places, and static maps	No	Yes	Yes
...
PostalCodes	Postal code search, country exports, and address validation data	No	Yes	Unknown
...
CPFHub	Brazilian CPF lookup — returns full name, birth date, and gender for any CPF	apiKey	Yes	Yes
...
Conversor IAE CNAE	Spanish IAE/CNAE tax activity codes, 2009→2025 crosswalk and AEAT obligations	apiKey	Yes	No
...
Disclosed Capitol	US congressional & executive-branch stock trade disclosures (STOCK Act + OGE)	apiKey	Yes	No
...
eCourtsIndia	Indian court case status, judgments, and hearing schedule API	apiKey	Yes	Yes
EPA	Web services and data sets from the US Environmental Protection Agency	No	Yes	Unknown
FastDOL	Federal enforcement records for US employers: OSHA, WHD, MSHA, EPA, NLRB, and more	apiKey	Yes	Yes
...
Indian Pincode	Free India PIN code lookup with GPS coordinates, 165k+ post offices, state & district data	No	Yes	Yes
...
LocalGov.jp	Japan grants and subsidies (central J-Grants + 1,916 municipalities)	No	Yes	Yes
National Park Service, US	Data from the US National Park Service	apiKey	Yes	Yes
Neotimo DGFiP Mirror	French DGFiP registry of certified e-invoicing platforms (Plateformes Agréées), searchable by SIRET	No	Yes	Unknown
...
OpenMercantil	Spanish company public data and BORME event timelines	No	Yes	Yes
OpenRegistry	Real-time queries to 27 national company registries (UK, FR, DE, IT, ES, KR + 21 more)	OAuth	Yes	Unknown
...
US Federal Contracts & Grants	US federal contracts, grants, and agency spending data updated daily	No	Yes	Yes
...
Health
API	Description	Auth	HTTPS	CORS
Clinical Trials Directory	Every clinical trial registered with ClinicalTrials.gov, indexed by condition and sponsor	No	Yes	Yes
...
Cure Cancer With AI	Oncology research, clinical trials, FDA approvals, news, and MAMMAL predictions	apiKey	Yes	No
Dataflow Kit COVID-19	COVID-19 live statistics into sites per hour	No	Yes	Unknown
Edamam	Food and nutrition data API with recipe search	apiKey	Yes	Unknown
...
Longevity World Cup	Public biological age competition data with biomarkers and rankings	No	Yes	Yes
Makeup	Makeup Information	No	No	Unknown
MedlinePlus Genetics	Genetic conditions, genes, chromosomes and mtDNA data	No	Yes	Unknown
...
Jobs
API	Description	Auth	HTTPS	CORS
AI Dev Jobs	AI/ML engineering job aggregator with REST, RSS, and MCP endpoints	No	Yes	Yes
...
Artificial Intelligence Jobs	Live AI/ML job listings from 260+ companies' own career pages, with salary, location, remote and seniority filters	No	Yes	Yes
...
freehire	Open-source search engine aggregating tech jobs from company ATS boards	No	Yes	No
GraphQL Jobs	Jobs with GraphQL	No	Yes	Yes
HeroHunt People Search	Search 1 billion people profiles across LinkedIn and GitHub for talent sourcing	apiKey	Yes	Yes
...
JobDataLake	1M+ enriched job listings from 20,000+ companies with salary, skills, seniority	apiKey	Yes	Yes
Open Skills	Job titles, skills and related jobs data	No	No	Unknown
Reed	Job board aggregator	apiKey	Yes	Unknown
TechRole Index	Russian IT profession, vacancy publication and salary aggregates	No	Yes	Yes
...
DeepAI	Provides AI-powered APIs for text generation, image processing, and more	apiKey	Yes	Yes
...
GoldBean	OCR, Translation, NLP & ERNIE LLM via Baidu AI (free tier available)	apiKey	Yes	Unknown
Groq	Fast AI inference API with free tier, supports Llama, Mixtral, Gemma models	apiKey	Yes	Yes
...
Hugging Face	AI model hub with inference API for NLP, computer vision, and audio	apiKey	Yes	Yes
...
Jina AI	Free AI API for embeddings, reranking, and text processing	apiKey	Yes	Yes
...
MediaCraft AI	Chinese content compliance review (17 platforms), EN↔CN translation, and SEO optimization. Pay-per-call via x402 (Solana USDC).	apiKey	Yes	Yes
...
Not Human Search	AI tool discovery with agentic scoring for 8,600+ tools and MCP servers	No	Yes	Yes
...
TensorFeed	Real-time AI news, model pricing, service status, and agent activity feeds	No	Yes	Yes
...
Sunor	AI music generation API via Suno, with pay-as-you-go credits	apiKey	Yes	Unknown
...
Verome	Music API for searching, streaming and exploring music data from YouTube Music, YouTube, and Last.fm	No	Yes	Unknown
⬆ Back to Index


News
API	Description	Auth	HTTPS	CORS
Mediastack	Free, Simple REST API for Live News & Blog Articles	apiKey	Yes	Unknown
...
Currents	Real-time and historical global news with multilingual support	apiKey	Yes	Yes
Feedbin	RSS reader	OAuth	Yes	Unknown
Florida Man	Static JSON dataset of 10,000+ Florida Man headlines by date	No	Yes	Yes
...
Newsflash	Deduplicated news events from 260+ sources with corroboration/confidence scores for AI agents	apiKey	Yes	No
NewsX	Get or Search Latest Breaking News with ML Powered Summaries 🤖	apiKey	Yes	Unknown
Noozra	Free news headlines from 200+ curated RSS sources	No	Yes	Yes
...
AcreLens	Land suitability scoring API for any US property: off-grid, rural, recreational, investment	apiKey	Yes	Unknown
...
InfraNode	Unified German city open data: weather, air quality, EV chargers, transit, demographics	apiKey	Yes	Unknown
Joshua Project	People groups of the world with the fewest followers of Christ	apiKey	Yes	Unknown
K-Data Gate	Korean market data: K-beauty/K-food products, Naver trends, stocks, real estate, weather	apiKey	Yes	Unknown
...
MostExpensiveWatches	Documented luxury watch auction records, live listings, valuations and price indices	No	Yes	Yes
ModelPartFinder Error Codes	Lookup appliance and equipment error codes by brand and code, with recommended replacement parts	No	Yes	Yes
Nasdaq Data Link	Stock market data	apiKey	Yes	Unknown
Nobel Prize	Open data about nobel prizes and events	No	Yes	Yes
Onyx Bazaar	Free public leaderboard of x402 paid HTTP services indexed from Coinbase CDP discovery API	No	Yes	Unknown
Open Data Minneapolis	Spatial (GIS) and non-spatial city data for Minneapolis	No	Yes	No
Open Scholarships	Free, openly-licensed directory of US scholarships and student aid from official sources	No	Yes	Yes
...
Pan Africa Data	Macroeconomic and subnational income distribution data for all 54 African countries	apiKey	Yes	Unknown
...
Statistics of the World	Economic data for 218 countries — GDP, population, inflation, and 440+ indicators from IMF and World Bank	No	Yes	Yes
Teleport	Quality of Life Data	No	Yes	Unknown
Tilth	Free daily UK fertiliser price index across nine grades, CC BY 4.0 licensed	No	Yes	Yes
...
Voidly	Internet censorship measurements, incidents, and ISP-level blocking data across 126 countries	No	Yes	No
Warnely	Composite travel-safety scores for 180 countries (FCDO + US State + GPI + WGI + live incident wire), OpenAPI 3.1 spec, CC BY 4.0	No	Yes	Yes
...
AstroWay	Astrology, natal charts, Human Design, Vedic and horoscopes on the Swiss Ephemeris	apiKey	Yes	Yes
...
Personality.fyi	Free MBTI personality types and OEJTS test scoring	No	Yes	Yes
...
Phone
API	Description	Auth	HTTPS	CORS
Numlookup	Phone number validation and carrier lookup API with global coverage	apiKey	Yes	Unknown
Numverify	Phone number validation	apiKey	Yes	Unknown
...
Phone Validation	Validate phone numbers globally	apiKey	Yes	Yes
Veriphone	Phone number validation & carrier lookup	apiKey	Yes	Yes
VeriRoute Intel	CNAM caller ID, carrier/LRN lookup and spam scoring for North American phone numbers	apiKey	Yes	Unknown
⬆ Back to Index


Photography
API	Description	Auth	HTTPS	CORS
Screenshotlayer	URL to screenshot	No	Yes	Unknown
...
Tinify.dev	Image compression, resize and crop API with usage metadata	apiKey	Yes	No
...
CodeCogs	Render LaTeX equations in PNG, GIF, SVG, EMF, PDF, JSON, or download formats with styling options	No	Yes	Unknown
...
OpenAlex	Open catalog of scholarly works, authors, institutions, sources, and concepts	No	Yes	Yes
OrbitalWiki	Catalog of 16,000+ satellites merging CelesTrak, GCAT, Wikidata; free tier included	apiKey	Yes	Yes
...
Tallytopia	Calculators for finance, health, math, space and sports with step-by-step results	No	Yes	Yes
...
dead-drop	Ephemeral zero-knowledge encrypted data sharing	No	Yes	Yes
Dehash.lt	Hash decryption MD5, SHA1, SHA3, SHA256, SHA384, SHA512	No	Yes	Unknown
Domain Intelligence	DNS, WHOIS/RDAP, SSL, subdomain enumeration, and email security in one parallel call	apiKey	Yes	No
...
FOFA	Search engine for Internet connected assets and devices	apiKey	Yes	Unknown
...
Hybrid Analysis	File and URL malware analysis powered by Falcon Sandbox	apiKey	Yes	Unknown
...
IPLogs	Free VPN, proxy, Tor and datacenter IP detection. 13 sources, active probing	No	Yes	Yes
...
SSL Domain Health Check	SSL certificate validity, domain WHOIS status, and DNS record checks for any domain	apiKey	Yes	Unknown
...
URLhaus	Database of malicious URLs used for malware distribution	No	Yes	Unknown
...
BuyWhere	Real-time product catalog API for AI agents across merchants in 7 countries (SG, MY, TH, VN, PH, ID, US)	apiKey	Yes	Unknown
Digi-Key	Retrieve price and inventory of electronic components as well as place orders	OAuth	Yes	Unknown
Descripio Amazon Reviews	Amazon product reviews for 12 marketplaces	apiKey	Yes	Unknown
...
Bluesky	Decentralized social networking via the AT protocol	No	Yes	Yes
...
GetXAPI	Read Twitter / X data and post tweets, likes, retweets, follows, DMs via REST	apiKey	Yes	Unknown
...
PostLake	One API to publish, schedule, and read analytics across every major social network	apiKey	Yes	No
...
xfetch	Read API for X/Twitter search, profiles, tweets, and social graph	apiKey	Yes	Yes
⬆ Back to Index
...
DiscGolf	Structured disc golf course data	No	Yes	Yes
...
Lumify	Real-time sports intelligence: scores, odds, betting splits & AI bet analysis across 8 sports	apiKey	Yes	No
...
Odds-API	Real-time sports betting odds from 265+ bookmakers across 34 sports via REST and WebSocket	apiKey	Yes	Yes
Oddsmagnet	Odds history from multiple UK bookmakers	No	Yes	Yes
OpenF1	Real-time and historical Formula 1 data including laps, car telemetry and positions	No	Yes	Yes
OpenLigaDB	Crowd sourced sports league results	No	Yes	Yes
Padel Snipe	4,000+ mapped padel clubs across 9 European countries with GPS and courts	No	Yes	Yes
Premier League Standings	All Current Premier League Standings and Statistics	apiKey	Yes	Unknown
PropLine	Real-time player-props betting odds with graded prop resolution across 13 books	apiKey	Yes	Unknown
RacingHub	Formula 1 historical data and statistics	No	Yes	Unknown
...
SportScore	Live scores, fixtures, standings and stats for football, basketball, cricket and tennis	No	Yes	Yes
...
TheRundown	Real-time sports data: odds, scores, stats & prediction markets, 30+ leagues, 18+ sportsbooks	apiKey	Yes	Yes
TheSportsDB	Crowd-Sourced Sports Data and Artwork	apiKey	Yes	Yes
TourneyRadar	Upcoming chess tournaments from 140+ national federations worldwide	No	Yes	Unknown
...
Test Data
API	Description	Auth	HTTPS	CORS
AddressMock	Random US, Hong Kong and Cape Verde addresses with matched city, state and ZIP	No	Yes	Yes
Bacon Ipsum	A Meatier Lorem Ipsum Generator	No	Yes	Unknown
Dicebear Avatars	Generate random pixel-art avatars	No	Yes	No
DummyJSON	Fake REST API with products, users, posts, comments, todos and more	No	Yes	Yes
...
TotalShiftLeft Sandbox	Free multi-protocol sandbox: REST, GraphQL & SOAP with OAuth2/JWT auth and OpenAPI 3.0 spec	No	Yes	Yes
...
Audexum	Text-to-speech REST API with 43 voices and 33 languages	apiKey	Yes	Yes
...
GeoScore	Score content for AI search citation readiness with a 0-100 GEO score and 8 structural metrics	apiKey	Yes	Yes
...
Kiprio Translate	Free text translation with language detection, supports 50+ languages	apiKey	Yes	Yes
Langbly	Context-aware text translation and language detection for 100+ languages	apiKey	Yes	Yes
...
Mapbox	Maps, directions, geocoding	apiKey	Yes	Unknown
...
WhereParcel	Unified parcel tracking API across 60+ carriers worldwide (USPS, FedEx, UPS, DHL, etc.)	apiKey	Yes	Yes
⬆ Back to Index
...
Apimetro	Geospatial data for Mexico City public transport system (Metro, Metrobús, Cablebús, RTP, etc.)	No	Yes	Yes
...
CruiseFeed	Normalized cruise line inventory: ships, sailings, itineraries, ports and lead-in fares	apiKey	Yes	Unknown
CTS	CTS Realtime API	apiKey	Yes	Yes
FAA N-Number Registry	Every FAA-registered civil aircraft in the United States, lookup by N-number or Mode S hex code	No	Yes	Yes
...
Orizn Visa	Visa requirements for 199 countries, 39K+ passport-destination pairs in 15 languages	apiKey	Yes	Yes
OpenSky Network	Free real-time ADS-B aviation data	No	Yes	Unknown
OpenVan	Fuel prices for 121 countries, food cost index & vanlife weather scores for RV travel	No	Yes	Yes
...
Road511	Unified traffic data from 65 US/CA jurisdictions: events, cameras, signs, bridges, truck routes	apiKey	Yes	No
...
RedirHub	URL redirect management with custom domains, HTTPS, analytics, and REST API	apiKey	Yes	Yes
...
Vehicle
API	Description	Auth	HTTPS	CORS
Auto Body Shop Directory	Find auto body shops by ZIP code, city, location, or profile	No	Yes	No
Brazilian Vehicles and Prices	Vehicles information from Fundação Instituto de Pesquisas Econômicas - Fipe	No	Yes	No
CarVector	Vehicle specs, images, recalls, and DTC codes across 1925-2029	apiKey	Yes	Yes
...
ProblemsByVin	Owner complaints, recalls and failure-mileage statistics by vehicle make, model and year	No	Yes	Yes
RevCarData	86,000+ global vehicle specifications and EV metrics	apiKey	Yes	Yes
...
Hyperserve	Video backend API: upload any format, transcode to MP4, deliver via CDN	apiKey	Yes	Yes
...
Rendobar	Hosted media processing over REST: transcode, caption, watermark video	apiKey	Yes	No
...
Weather
API	Description	Auth	HTTPS	CORS
Weatherstack	Real-Time & Historical World Weather Data API	apiKey	Yes	Unknown
...
IPMA	Portuguese weather and climate data	No	Yes	Unknown
Meltema	Multi-model weather: GFS, ECMWF AIFS/IFS and a 31-member GEFS ensemble, keyless point forecasts	No	Yes	No
...
Pirate Weather	Free weather API with forecast data similar to Dark Sky	No	Yes	Yes
QWeather	Location-based weather data	apiKey	Yes	Yes
Rainbow Weather	Global real-time nowcasting API powered by radar + satellite fusion	apiKey	Yes	Unknown
...
wttr.in	Weather in your terminal, supports JSON output	No	Yes	Yes
