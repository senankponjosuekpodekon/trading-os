    ...
    return [
      {
        ...
        strategy: {
          type: 'trend',
          filters: [
            { indicator: 'ema', fast: 20, slow: 50, condition: 'above' },
            { indicator: 'adx', threshold: 25, condition: 'above' },
          ],
          entry: { trigger: 'pullback_ema20', confirmation: 'candle_close' },
          exit: { stop_loss_atr: 1.5, take_profit_atr: 2.5 },
        },
      },
      {
        id: 'breakout_smc',
        ...
        strategy: {
          type: 'breakout',
          filters: [
            { indicator: 'structure', condition: 'swing_breakout' },
            { indicator: 'order_block', condition: 'fresh' },
            { indicator: 'volume', condition: 'increasing' },
          ],
          entry: { trigger: 'close_above_breakout' },
          exit: { stop_loss_atr: 1.0, take_profit_atr: 2.0, trailing_atr: 1.5 },
        },
      },
      {
        ...
        strategy: {
          type: 'range',
          filters: [
            { indicator: 'support_resistance', condition: 'range_bound' },
            { indicator: 'rsi', threshold: 30, condition: 'oversold' },
          ],
          entry: { trigger: 'support_touch' },
          exit: { stop_loss_atr: 1.0, take_profit_atr: 1.8, target: 'resistance' },
        },
      },
    ];
  }
