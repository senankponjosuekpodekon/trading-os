...
def dxy_correlation_bonus(
    ...
    if dxy_trend == "bearish" and signal == "BUY":
        ...
        bonus += 5  # counter-trend: reduced conviction
        reasons.append("DXY bearish but SELL signal → reduced conviction (+5)")
    elif dxy_trend == "bullish" and signal == "BUY":
        bonus += 5
        reasons.append("DXY bullish but BUY signal → reduced conviction (+5)")
